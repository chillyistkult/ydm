// Generated on 2015-10-30 using generator-angular-fullstack 3.0.0-rc8
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            injectLess: {
                files: ['<%= yeoman.client %>/{app,components,assets}/**/*.less'],
                tasks: ['injector:less']
            },
            less: {
                files: ['<%= yeoman.client %>/{app,components,assets}/**/*.less'],
            ...
            less: {
                options: {
                    transform: function (filePath) {
                        ...
                        filePath = filePath.replace('/client/assets/', '../assets/');
